...
def das_script():
    ...
    '''
    Sell Limit on the Bid - 0.05 with $200 risk and stop equal to the price field
    '''
    print("Bid=%.2f" % Bid)
    print("Ask=%.2f" % Ask)
    ...
    TrailPrice = StopPrice - Bid + FLOAT_SLIPPAGE
    ...
    # Set the price to the Bid - Slippage
    Price = Bid - FLOAT_SLIPPAGE
